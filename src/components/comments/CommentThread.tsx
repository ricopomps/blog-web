...
interface CommentThreadProps {
  ...
  onCommentDeleted: (updatedComment: CommentModel) => void;
}
...
export default function CommentThread({
  ...
  function handeReplyCreated(reply: CommentModel) {
  ...
  return (
    <div>
      <Comment
        comment={comment}
        onReplyCreated={handeReplyCreated}
...
interface RepliesProps {
  ...
  onReplyUpdated: (reply: CommentModel) => void;
